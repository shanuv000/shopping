            ...
            <div class="col-md-4 p-0">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <p class="card-text">Donec rutrum congue leo eget malesuada. Pellentesque in ipsum id orci porta
                            dapibus. Vestibulum
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <p class="card-text">Pellentesque in ipsum id orci porta dapibus. Vestibulum ac diam sit amet
                            quam vehicula elementum.</p>
                        <p class="card-text">
            ...
            <div class="col-md-4 0">
                ...
                <div class="card text-center">
                    <div class="card-body">
                        ...
                        <p class="card-text">TDonec rutrum congue leo eget malesuada. Pellentesque in ipsum id orci
                            porta dapibus. Vestibulum
                            ac diam sit.
                        </p>
                        <p class="card-text">
                            <small class="text-muted">Last updated 3 mins ago</small>
