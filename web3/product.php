                        ...
                        <div class="col-lg-3 col-sm-6 p-0">
                            ...
                            <div class="card product-men p-3">
                                <div class="men-thumb-item">
                                    <img src="../images/<?= $irow['pro_img']; ?>" height="350px" width="200px" alt="img"
                                         class="card-img-top">
                                    <div class="men-cart-pro">
                                        <?php $product_query= mysqli_query($shanu->con, "select * from product_details where pro_id=''");
$rows = mysqli_fetch_assoc($product_query);
?>
                                        <div class="inner-men-cart-pro">
                                            <a href="mens.php?id=<?= $rows[''];?>" class="link-product-add-cart">Quick View</a>
                                        </div>
                                    </div>
                                </div>
                                <!-- card body -->
