...
<!--out.print("Hello "+user+"ji you are now logged in");-->



<!--//             Class.forName("com.mysql.jdbc.Driver");-->
<!--//            Connection con=DriverManager.getConnection("jdbc:mysql://localhost:3306/online_shoping","root","");-->
<!--//              Statement pstmt=con.createStatement();-->
<!--//-->
<!--//              String query ="select c_email,c_mobile from customer where c_username = '"+user+"'";-->
<!--//-->
