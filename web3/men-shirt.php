        ...
        <div class="row my-lg-5 mb-5">
            ...
            <div class="col-lg-9 mt-lg-0 mt-5 right-product-grid">
                ...
                <div class="card-group">
                    <!-- card -->
                    <?php
                    $query = mysqli_query($shanu->con, "select * from product_details where pro_category='$men_cat'");
                    $i = 0;
                    while ($i <= 3) {
                        while ($row = mysqli_fetch_assoc($query)) { ?>
                            <div class="col-lg-3 col-sm-6 p-0">
                                <?php $id = $row['pro_id']; ?>
                                <?php $image_query = mysqli_query($shanu->con, "select * from product_image where product_id='$id'");
                    ...
                    <!--                            <!-- card body -->-->
                    <!--                            <div class="card-body  py-3 px-2">-->
                    <!--                                <h5 class="card-title text-capitalize">Solid Formal Blue Shirt</h5>-->
                    <!--                                <div class="card-text d-flex justify-content-between">-->
                    ...
                    <!--                                    <input type="hidden" name="cmd" value="_cart">-->
                    <!--                                    <input type="hidden" name="add" value="1">-->
                    <!--                                    <input type="hidden" name="hub_item" value="Solid Formal Blue Shirt">-->
                    ...
                    <!--                                <!-- card body -->-->
                    <!--                                <div class="card-body  py-3 px-2">-->
                    <!--                                    <h5 class="card-title text-capitalize">Slim Fit Men's Blue Trousers</h5>-->
                    <!--                                    <div class="card-text d-flex justify-content-between">-->
                    ...
                    <!--                                        <input type="hidden" name="cmd" value="_cart">-->
                    <!--                                        <input type="hidden" name="add" value="1">-->
                    <!--                                        <input type="hidden" name="hub_item" value="Slim Fit Men's Blue Trousers">-->
                    ...
                    <!--                                <!-- card body -->-->
                    <!--                                <div class="card-body  py-3 px-2">-->
                    <!--                                    <h5 class="card-title text-capitalize">Slim Fit Men Black Jeans</h5>-->
                    <!--                                    <div class="card-text d-flex justify-content-between">-->
                    <!--                                        <p class="text-dark font-weight-bold">$21.99</p>-->
                    <!--                                        <p class="line-through">$25.99</p>-->
                    <!--                                    </div>-->
                    ...
                    <!--                                        <input type="hidden" name="cmd" value="_cart">-->
                    <!--                                        <input type="hidden" name="add" value="1">-->
                    <!--                                        <input type="hidden" name="hub_item" value="Slim Fit Men Black Jeans">-->
                    <!--                                        <input type="hidden" name="amount" value="21.99">-->
                    <!--                                        <button type="submit" class="hub-cart phub-cart btn">-->
                    <!--                                            <i class="fa fa-cart-plus" aria-hidden="true"></i>-->
                    <!--                                        </button>-->
                    ...
                    <!--                                <!-- card body -->-->
                    <!--                                <div class="card-body  py-3 px-2">-->
                    <!--                                    <h5 class="card-title text-capitalize">Slim Men's Dark Blue Jeans</h5>-->
                    <!--                                    <div class="card-text d-flex justify-content-between">-->
                    ...
                    <!--                                        <input type="hidden" name="cmd" value="_cart">-->
                    <!--                                        <input type="hidden" name="add" value="1">-->
                    <!--                                        <input type="hidden" name="hub_item" value="Slim Men's Dark Blue Jeans">-->
