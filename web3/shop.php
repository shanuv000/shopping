        ...
        <div class="container">
            ...
            <div class="py-sm-5 py-3 right-product-grid">
                ...
                <div class="row card-group my-sm-5 mt-5">
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="card py-sm-5 border-0">
                            <a class="btn-lg btn-secondary text-center m-5" href="men.php">View More</a>
                        </div>
                    </div>
                    <!-- //card 2 -->
                </div>
                ...
                <div class="row card-group my-sm-5 mt-5">
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="card py-sm-5 border-0">
                            <a class="btn-lg btn-secondary text-center m-5" href="women.php">View More</a>
                        </div>
                    </div>
                    <!-- //card 2 -->
                </div>
                ...
                <div class="card-group my-sm-5 mt-5">
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="card py-sm-5 border-0">
                            <a class="btn-lg btn-secondary text-center m-5" href="girls.php">View More</a>
                        </div>
                    </div>
                </div>
                <!-- //card group -->
                ...
                <div class="card-group my-5">
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="card py-sm-5 border-0">
                            <a class="btn-lg btn-secondary text-center m-5" href="boys.php">View More</a>
                        </div>
                        <!-- //row  -->
                    </div>
                </div>
