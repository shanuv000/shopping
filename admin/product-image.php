...
//    $target = "images/" . basename($_FILES['photo']['name']);
    ...
    $ins_query  = mysqli_query($shanu->con,"insert into product_image(product_id,pro_img) VALUES('$p_id','$image')");
    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0 text-dark">Product - Image</h1>
                    </div><!-- /.col -->
                    <div class="col-sm-6">
                    ...
                    <div class="form-group" >
                        <select name="p_id" class="form-control">
                            <?php while ($row = mysqli_fetch_assoc($query)) { ?>
                                <option value="<? echo $row['pro_id']; ?>"><? echo $row['pro_name']; ?></option>
                            <? } ?>
                        </select>
                    </div>
                    <div class="form-group">
