...
<head>
    <title>Fashion Hub Ecommerce Category </title>
                    ...
                    <li class="nav-item dropdown has-mega-menu" style="position:static;">
                        ...
                        <div class="dropdown-menu" style="width:100%">
                            <div class="px-0 container">
                                <div class="row">
                                    <div class="col-md-4">
                                        <a class="dropdown-item" href="includes/men.php">T-Shirts</a>
                                        <a class="dropdown-item" href="includes/men.php">Coats</a>
                                        <a class="dropdown-item" href="includes/men.php">Shirts</a>
                                        <a class="dropdown-item" href="includes/men.php">Suits & Blazers</a>
                                        <a class="dropdown-item" href="includes/men.php">Jackets</a>
                                        <a class="dropdown-item" href="includes/men.php">Trousers</a>
                                    </div>
                                    <div class="col-md-4">
                                        <a class="dropdown-item" href="includes/men.php">T-Shirts</a>
                                        <a class="dropdown-item" href="includes/men.php">Trousers</a>
                                        <a class="dropdown-item" href="includes/men.php">Shirts</a>
                                        <a class="dropdown-item" href="includes/men.php">Suits & Blazers</a>
                                        <a class="dropdown-item" href="includes/men.php">Coats & Jackets</a>
                                        <a class="dropdown-item" href="includes/men.php">Jackets</a>
                                    </div>
                                    <div class="col-md-4">
                                        <a class="dropdown-item" href="includes/men.php">T-Shirts</a>
                ...
                <div class="container">
                    ...
                    <div class="slider-info mt-sm-5">
                        ...
                        <div class="bnr_clip position-relative">
                            ...
                            <a class="btn btn-primary mt-3 text-capitalize" href="shop.php" role="button">shop now</a>
                        </div>
                    </div>
                </div>
            </li>
...
<div class="row no-gutters pb-5">
    ...
    <div class="col-sm-4">
        <div class="hovereffect">
            ...
            <div class="overlay">
                <h5>men's fashion</h5>
                <a class="info" href="includes/men.php">Shop Now</a>
            </div>
        </div>
    </div>
    <div class="col-sm-4">
            ...
            <ul id="clothing-nav" class="nav nav-tabs tabs-style-line" role="tablist">
                <li class="nav-item">
                    <a class="nav-link active" href="#women" id="women-tab" role="tab" data-toggle="tab"
                       aria-controls="women" aria-expanded="true">Women's Fashion</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="#men" role="tab" id="men-tab" data-toggle="tab" aria-controls="men">Men's
                        Fashion
                    </a>
                </li>
                <li class="nav-item">
            ...
            <div role="tabpanel" class="tab-pane fade" id="men" aria-labelledby="men-tab">
                <div id="owl-demo1" class="owl-carousel text-center">
                    ...
                    <div class="item">
                        ...
                        <div class="product-men p-3 text-center">
                            <img src="images/p2.png" class="img-responsive" alt="">
                            <a href="includes/men.php" class="btn btn-lg bg-info text-white">view more</a>
                        </div>
                        <!-- //card -->
                    </div>
                </div>
