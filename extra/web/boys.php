...
<body>
    <header>
        <div class="container">
            <!-- middle bar -->
            <nav class="middleBar d-flex pt-3 pb-1">
                <!-- logo -->
                <h1>
                ...
                <div class="ml-auto d-flex">
                    <!-- search form -->
                    <form class="nav-search form-inline m-2 my-lg-0 form-control" action="#" method="post">
                        ...
                        <button class="btn btn-outline-secondary my-2 ml-3 my-sm-0" type="submit">Search</button>
                    </form>
                    <!-- search form -->
                    <!-- sigin and sign up -->
                    <a class="text-dark login_btn d-flex align-self-center" href="#myModal_btn" data-toggle="modal" data-target="#myModal_btn">
