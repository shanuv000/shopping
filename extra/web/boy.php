...
<head>
    <title>Fashion Hub Ecommerce Category Bootstrap Responsive Website Template| Boy :: w3layouts</title>
...
<body>
            ...
            <nav class="navbar navbar-expand-lg navbar-light justify-content-center">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav mx-auto text-center">
                        ...
                        <li class="nav-item dropdown has-mega-menu" style="position:static;">
                            <a class="nav-link dropdown-toggle active" data-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false">Kids Clothing</a>
                            <div class="dropdown-menu" style="width:100%">
                                <div class="container">
    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item">
                <a href="boys.php">Boy's Clothing</a>
            </li>
        ...
        <div class="container">
            <div class="row my-sm-5">
                <div class="col-lg-4 single-right-left">
                    <div class="grid images_3_of_2">
                        <div class="flexslider1">
                            <ul class="slides">
                                <li data-thumb="images/pbb1.jpg">
                                    <div class="thumb-image">
                                        <img src="images/pbb1.jpg" data-imagezoom="true" alt=" " class="img-fluid"> </div>
                                </li>
                                <li data-thumb="images/pbb2.jpg">
                                    <div class="thumb-image">
                                        <img src="images/pbb2.jpg" data-imagezoom="true" alt=" " class="img-fluid"> </div>
                                </li>
                                <li data-thumb="images/pbb3.jpg">
                                    <div class="thumb-image">
                                        <img src="images/pbb3.jpg" data-imagezoom="true" alt=" " class="img-fluid"> </div>
                                </li>
                            </ul>
                ...
                <div class="col-lg-8 mt-lg-0 mt-5 single-right-left simpleCart_shelfItem">
                    <h3>AJ Dezines Boys Festive & Party Shirt, Waistcoat and Pant Set
                    </h3>
                    <div class="caption">
                    ...
                    <div class="d-sm-flex justify-content-between">
                        <div class="occasional">
                            ...
                            <ul class="single_specific">
                                <li>
                                    <span> Fabric: </span>Cotton</li>
                                <li>
                                    <span>Color :</span> Blue</li>
                                <li>
                                    <span> Ideal For:</span> Boys</li>
                                <li>Full Sleeve Shirt Waistcoat and Pant Set</li>
                            </ul>
        ...
        <div class="container">
            <div class="new_arrivals">
                ...
                <div class="card-group my-5">
                    ...
                    <div class="card product-men p-3">
                        <div class="men-thumb-item">
                            <img src="images/pb11.jpg" alt="img" class="card-img-top">
                            <div class="men-cart-pro">
                                <div class="inner-men-cart-pro">
                                    <a href="boy.html" class="link-product-add-cart">Quick View</a>
                                </div>
                        ...
                        <!-- card body -->
                        <div class="card-body  py-3 px-2">
                            <h5 class="card-title text-capitalize">Casual Shirt and Trouser Set</h5>
                            <div class="card-text d-flex justify-content-between">
                        ...
                        <div class="card-footer d-flex justify-content-end">
                            <form action="#" method="post">
                                <input type="hidden" name="cmd" value="_cart">
                                <input type="hidden" name="add" value="1">
                                <input type="hidden" name="hub_item" value="Casual Shirt and Trouser Set">
                    ...
                    <div class="card product-men p-3">
                        ...
                        <div class="card-body  py-3 px-2">
                            ...
                            <div class="card-text d-flex justify-content-between">
                                <p class="text-dark font-weight-bold">$14.00</p>
