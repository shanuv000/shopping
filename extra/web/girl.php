...
<body>
    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item">
                <a href="girls.html">Girl's Clothing</a>
            </li>
                            ...
                            <ul class="slides">
                                <li data-thumb="images/pgg1.jpg">
                                    <div class="thumb-image">
                                        <img src="images/pgg1.jpg" data-imagezoom="true" alt=" " class="img-fluid"> </div>
                                </li>
                                <li data-thumb="images/pgg2.jpg">
                                    <div class="thumb-image">
                                        <img src="images/pgg2.jpg" data-imagezoom="true" alt=" " class="img-fluid"> </div>
                                </li>
                                <li data-thumb="images/pgg3.jpg">
                                    <div class="thumb-image">
                                        <img src="images/pgg3.jpg" data-imagezoom="true" alt=" " class="img-fluid"> </div>
                                </li>
                            </ul>
                ...
                <div class="card-group my-5">
                    ...
                    <div class="card product-men p-3">
                        ...
                        <div class="card-body  py-3 px-2">
                            ...
                            <div class="card-text d-flex justify-content-between">
                                <p class="text-dark font-weight-bold">$90.00</p>
                    ...
                    <div class="card product-men p-3">
                        ...
                        <div class="card-body  py-3 px-2">
                            ...
                            <div class="card-text d-flex justify-content-between">
                                <p class="text-dark font-weight-bold">$75.00</p>
                                <p class="line-through">$85.99</p>
                            </div>
                        </div>
                        <!-- card footer -->
                        <div class="card-footer d-flex justify-content-end">
                    ...
                    <div class="card product-men p-3">
                        ...
                        <div class="card-body  py-3 px-2">
                            ...
                            <div class="card-text d-flex justify-content-between">
                                <p class="text-dark font-weight-bold">$59.00</p>
                                <p class="line-through">$75.00</p>
                            </div>
                        </div>
                        <!-- card footer -->
                        <div class="card-footer d-flex justify-content-end">
                    ...
                    <div class="card product-men p-3">
                        ...
                        <div class="card-body  py-3 px-2">
                            ...
                            <div class="card-text d-flex justify-content-between">
                                <p class="text-dark font-weight-bold">$65.99</p>
                                <p class="line-through">$85.99</p>
                            </div>
                        </div>
                        <!-- card footer -->
