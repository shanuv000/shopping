...
<head>
    ...
    <meta name="keywords"
          content="Delightful Profile template Responsive, Login form web template,Flat Pricing tables,Flat Drop downs  Sign up Web Templates, Flat Web Templates, Login sign up Responsive web template, SmartPhone Compatible web template, free webdesigns for Nokia, Samsung, LG, SonyEricsson, Motorola web design"/>
    ...
    <link href="//fonts.googleapis.com/css?family=Arsenal:400,400i,700,700i&amp;subset=cyrillic,cyrillic-ext,latin-ext,vietnamese"
          rel="stylesheet">
</head>
<body>
<div class="main">
        ...
        <div class="w3layouts_main_grid_left">
            <div class="w3_main_grid_left_grid">
                ...
                <ul class="agileinfo_social_icons">
                    <li><a href="#" class="w3_agileits_facebook"><i class="fa fa-facebook" aria-hidden="true"></i></a>
                    </li>
                    <li><a href="#" class="wthree_twitter"><i class="fa fa-twitter" aria-hidden="true"></i></a></li>
                    <li><a href="#" class="agileinfo_google"><i class="fa fa-google-plus" aria-hidden="true"></i></a>
                    </li>
                </ul>
            </div>
        </div>
                        ...
                        <div class="wthree_main_grid_right_grid">
                            ...
                            <div class="w3_agileits_main_grid_work_grids">
                                <div class="agile_main_grid_work_gridl">
                                    <a href="images/1.jpg" class="showcase" data-rel="lightcase:myCollection:slideshow"
                                       title="Easy Profile">
                                        <img src="images/1.jpg" alt=" "/>
                                    </a>
                                </div>
                                <div class="agile_main_grid_work_gridl">
                                    <a href="images/2.jpg" class="showcase" data-rel="lightcase:myCollection:slideshow"
                                       title="Easy Profile">
                                        <img src="images/2.jpg" alt=" "/>
                                    </a>
                                </div>
                                <div class="agile_main_grid_work_gridl">
                                    <a href="images/3.jpg" class="showcase" data-rel="lightcase:myCollection:slideshow"
                                       title="Easy Profile">
                                        <img src="images/3.jpg" alt=" "/>
                                    </a>
                                </div>
                                <div class="agile_main_grid_work_gridl">
                                    <a href="images/4.jpg" class="showcase" data-rel="lightcase:myCollection:slideshow"
                                       title="Easy Profile">
                                        <img src="images/4.jpg" alt=" "/>
                                    </a>
                                </div>
                                <div class="agile_main_grid_work_gridl">
                                    <a href="images/5.jpg" class="showcase" data-rel="lightcase:myCollection:slideshow"
                                       title="Easy Profile">
                                        <img src="images/5.jpg" alt=" "/>
                                    </a>
                                </div>
                                <div class="agile_main_grid_work_gridl">
                                    <a href="images/6.jpg" class="showcase" data-rel="lightcase:myCollection:slideshow"
                                       title="Easy Profile">
                                        <img src="images/6.jpg" alt=" "/>
                                    </a>
                                </div>
                                <div class="agile_main_grid_work_gridl">
                                    <a href="images/7.jpg" class="showcase" data-rel="lightcase:myCollection:slideshow"
                                       title="Easy Profile">
                                        <img src="images/7.jpg" alt=" "/>
                                    </a>
                                </div>
                                <div class="agile_main_grid_work_gridl">
                                    <a href="images/8.jpg" class="showcase" data-rel="lightcase:myCollection:slideshow"
                                       title="Easy Profile">
                        ...
                        <div class="wthree_main_grid_right_grid">
                            ...
                            <form action="#" method="post">
                                ...
                                <div class="agileits_w3layouts_contact_right">
                                    <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d77944.63844269582!2d4.828574749828488!3d52.37459125089173!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x47c63fb5949a7755%3A0x6600fd4cb7c0af8d!2sAmsterdam%2C+Netherlands!5e0!3m2!1sen!2sin!4v1485595363072"
