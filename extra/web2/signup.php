...
if (isset($_POST['submit'])) {
    ...
    if (!($password == $checkpassword)) {
        ...
        $query = mysqli_query($shanu->con, "insert into customer(  c_username, c_password, c_email, c_date) values('$username','$password','$email',now())");
        ?>
        ...
        <div class="modal-body pt-3 pb-5 px-sm-5">
            <div class="row">
                <div class="col-md-6 mx-auto align-self-center">
                    <img src="images/WhatsApp1.jpg" class="img-fluid" alt="login_image"/>
